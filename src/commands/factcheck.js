  ...
  execute: async (sock, msg, args) => {
    ...
    if ('factcheck' === 'translate') {
      ...
      const input = args.join(' ').trim() || (
        ['improve','summarize','grammar','formal','casual'].includes('factcheck') ? getQuotedText(msg) : ''
      );
